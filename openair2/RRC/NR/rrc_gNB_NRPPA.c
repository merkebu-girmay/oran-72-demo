...
static nrppa_srs_configuration_t cp_f1ap_to_nrppa_srs_configuration(f1ap_srs_configuration_t *in)
{
  ...
  for (int l = 0; l < srs_carrier_list_length; l++) {
    ...
    for (int i = 0; i < scs_specific_carrier_list_length; i++) {
      ...
      // subcarrier spacing
      switch (f1_scs->subcarrier_spacing) {
        case F1AP_SUBCARRIER_SPACING_15KHZ:
          nrppa_scs->subcarrier_spacing = NRPPA_SUBCARRIER_SPACING_15KHZ;
          break;
        case F1AP_SUBCARRIER_SPACING_30KHZ:
          nrppa_scs->subcarrier_spacing = NRPPA_SUBCARRIER_SPACING_30KHZ;
          break;
        case F1AP_SUBCARRIER_SPACING_60KHZ:
          nrppa_scs->subcarrier_spacing = NRPPA_SUBCARRIER_SPACING_60KHZ;
          break;
        case F1AP_SUBCARRIER_SPACING_120KHZ:
          nrppa_scs->subcarrier_spacing = NRPPA_SUBCARRIER_SPACING_120KHZ;
          break;
        default:
    ...
    // subcarrier spacing
    switch (f1_active_ul_bwp->subcarrier_spacing) {
      case F1AP_SUBCARRIER_SPACING_15KHZ:
...
static f1ap_srs_configuration_t cp_nrppa_to_f1ap_srs_configuration(nrppa_srs_configuration_t *in)
{
  ...
  nrppa_srs_carrier_list_t *srs_carrier_list = &in->srs_carrier_list;
  ...
  for (int l = 0; l < srs_carrier_list_length; l++) {
    ...
    for (int i = 0; i < scs_specific_carrier_list_length; i++) {
      ...
      // subcarrier spacing
      switch (nrppa_scs->subcarrier_spacing) {
    ...
    switch (active_ul_bwp->subcarrier_spacing) {
      case NRPPA_SUBCARRIER_SPACING_15KHZ:
        f1_active_ul_bwp->subcarrier_spacing = F1AP_SUBCARRIER_SPACING_15KHZ;
        break;
      case NRPPA_SUBCARRIER_SPACING_30KHZ:
        f1_active_ul_bwp->subcarrier_spacing = F1AP_SUBCARRIER_SPACING_30KHZ;
        break;
      case NRPPA_SUBCARRIER_SPACING_60KHZ:
        f1_active_ul_bwp->subcarrier_spacing = F1AP_SUBCARRIER_SPACING_60KHZ;
        break;
      case NRPPA_SUBCARRIER_SPACING_120KHZ:
        f1_active_ul_bwp->subcarrier_spacing = F1AP_SUBCARRIER_SPACING_120KHZ;
        break;
      default:
        AssertFatal(false, "Illegal Subcarrier Spacing\n");
        break;
