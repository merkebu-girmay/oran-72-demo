...
static uint32_t bitmap_to_rbg_allocation(const uint8_t *rbBitmap, const NR_UE_DL_BWP_t *dl_BWP, int N_RBG)
{
                                       ...
                                       bool is_sib1)
{
  ...
  if (sched_pdsch->alloc_type == PDSCH_TYPE1)
    ...
    dci_payload.frequency_domain_assignment.val = bitmap_to_rbg_allocation(sched_pdsch->rbBitmap,
                                                                           dl_BWP,
                                                                           dci_payload.frequency_domain_assignment.nbits);
